...
console.log("🧪 Live Google OAuth Test");
...
async function testOAuthEndpoints() {
  ...
  try {
    ...
    console.log(`Supabase OAuth endpoint: ${supabaseResponse.status} ${supabaseResponse.status === 302 ? '✅' : '❌'}`);
    ...
    console.log(`Google OAuth endpoint: ${googleResponse.status} ${googleResponse.status === 302 ? '✅' : '❌'}`);
